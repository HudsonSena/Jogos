# Projeto Jogo de RPG versão 01

Jogo em linguagem C e Allegro 5.
...
## Observações:
Jogo desenvolvido para um plano b, caso não tivesse concluído as funções básicas do Dinno Meteor02.
